...
const SelectFormInput = ({
  ...
  return <Controller control={control} name={name} render={({
    ...
    fieldState
          ...
          {/* @ts-ignore */}
          <ReactSelect {...other} {...field} options={options} onChange={e => field.onChange(e.value)} value={Array.isArray(options) && options?.find(op => 'value' in op && op.value == field.value)} className={className} classNamePrefix="react-select" id={id ?? name} />
