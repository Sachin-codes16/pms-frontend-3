...
const InspectionEditDetailsPage = ({ mode = "check-out" }) => {
  ...
  const backPath = `/check-out-details?id=${id}&tab=inspection`;
            ...
            <Card className="border-0 shadow-sm" style={{ borderRadius: 10, boxShadow: "0 10px 30px rgba(16,24,40,0.07)", overflow: "hidden" }}>
              <CardBody style={{ padding: 0 }}>
                ...
                <div style={{ padding: "34px 36px" }}>
                  ...
                  <h5 id="property-inspection" style={sectionTitleStyle}>A. Property Inspection</h5>
                  <Row className="g-4 mb-5">
                    <Col md={4}>
                      <SelectField label="Inspection Required" name="inspection_required"
                        defaultValue={gv("inspection_required")} options={["Yes", "No"]} />
                    </Col>
                    <Col md={4}>
                      <Field label="Inspection Date" name="inspection_date" type="date"
                    ...
                    <Col md={4}>
                      <SelectField label="Manager Approval" name="manager_approval"
                        defaultValue={gv("manager_approval")}
                        options={["Pending", "Approved", "Rejected"]} />
                    </Col>
                    <Col md={4}>
                      <SelectField label="Inspection Priority" name="inspection_priority"
                        defaultValue={gv("inspection_priority")}
                  ...
                  <Row className="g-4 mb-5">
                    ...
                    <Col md={12}>
                      <TextArea label="Supervisor Remarks" name="supervisor_remarks"
