            ...
            <CardBody style={{ padding: 0 }}>
              ...
              <div style={{ padding: "34px 36px" }}>
                ...
                <Row className="g-4 mb-4">
                  ...
                  <Col md={4}>
                    <DateField label="Agreement Start Date" />
                  </Col>
                  <Col md={4}>
                    <DateField label="Agreement End Date" />
                  </Col>
                  <Col md={4}>
                    <FormField
                ...
                <Row className="g-4 mb-4">
                  <Col md={4}>
                    <DateField label="Generated On" />
                  </Col>
                  <Col md={4}>
                    <DateField label="Submitted to Tenant" />
                  </Col>
                  <Col md={4}>
                    <DateField label="Tenant Signed On" />
                  </Col>
                  <Col md={4}>
                    <DateField label="Manager Signed On" />
                  </Col>
                  <Col md={4}>
                    <DateField label="Renewal Reminder" />
                  </Col>
                  <Col md={4}>
                    <FormField
                      label="Auto Reminder"
