...
const ReviewsPage = () => {
  const reviewData = useFetchData(getAllReview);
  return <>
                    ...
                    {reviewData?.map((item, idx) => <tr key={idx}>
                        ...
                        <td>
                          <div className="d-flex align-items-center gap-2">
                            <div>
                              {item.property?.image && <img src={item.property.image} alt="Property" className="avatar-md rounded border border-light border-3" />}
                            </div>
                            <div>
