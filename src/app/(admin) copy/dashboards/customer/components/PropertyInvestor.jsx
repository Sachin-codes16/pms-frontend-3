      ...
      <Card>
        ...
        <CardBody>
          <div className="d-flex align-items-center gap-3">
            <img src={avatar2} className="rounded avatar-xl img-thumbnail" alt="img-7" />
            <div>
              <h4 className="mb-1">
                <Link to="/customers/details" className="mb-1 link-dark fw-semibold">
                  Daavid Nummi
                </Link>
              </h4>
              ...
              <ul className="list-inline d-flex flex-wrap gap-1 mb-0 align-items-center mt-2">
                <li className="list-inline-item">
                  <Button variant="soft-primary" className="d-flex align-items-center justify-content-center avatar-sm">
                    <span>
