      ...
      <div className="d-flex flex-column h-100">
        <div className="d-block">
          <div className="d-flex rounded gap-2">
            <div className="position-relative ">
              <img src={avatar3} alt="avatar" className="avatar rounded-circle flex-shrink-0" />
            </div>
              ...
              <div className="mt-4">
                ...
                <div className="my-4 bg-light rounded p-2">
                  <Row className="g-2">
                    {emailBodyImageData.map((img, idx) => <Col lg={3} key={idx}>
                        <Link to="">
                          <img src={img?.image} alt="small" className="img-fluid rounded" />
                        </Link>
                      </Col>)}
                  </Row>
                  <div className="d-flex align-items-center gap-2 mt-3">
                    <img src={avatar3} alt="avatar" className="avatar-sm rounded-circle" />
                    <Link to="" className="text-dark fw-medium">
                      Dianna Blair
                    </Link>
                    <p className="mb-0">attached 4 photos</p>
                    <div className="ms-auto">
                      <Link to="" className="text-muted d-flex align-items-center gap-1">
                ...
                <div className="my-4">
                  <Row className="align-items-center text-center g-2">
                    ...
                    <Col lg={4}>
                      <Link to="" className="link-primary fw-medium d-flex align-items-center gap-1">
  ...
  return <div className="position-relative">
      ...
      <CardFooter className="bg-light-subtle border-top w-100">
        <div className="d-flex gap-2">
          <img src={avatar1} alt="avatar" className="avatar rounded-circle" />
          <div className="w-100">
            <p className="mb-2">
            ...
            <div className="d-flex flex-wrap justify-content-between mt-2 align-items-center">
              <div className="d-flex gap-3">
                ...
                <Link to="" className="text-dark fs-18 fw-medium">
