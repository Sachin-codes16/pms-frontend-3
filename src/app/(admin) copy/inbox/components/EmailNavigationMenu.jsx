        ...
        <ModalBody className="p-4">
          <div className="overflow-hidden">
            ...
            <div className="d-flex float-end">
              ...
              <Button variant="light" onClick={toggleCompase} className="compose-close">
      ...
      height: 'calc(100vh - 280px)'
        ...
        <CardBody className="pt-0">
          <div className="email-menu-list d-flex flex-column gap-2">
            <Link to="" className="active" onClick={() => changeActiveLabel('Primary')}>
        ...
        <CardBody className="border-top border-light">
          <Link to="" onClick={toggleContact} className="btn-link d-flex align-items-center text-dark fw-semibold  mb-0" data-bs-toggle="collapse" data-bs-target="#contacts" aria-expanded="false" aria-controls="contacts">
          ...
          <Collapse in={isOpenContact}>
            <div>
              <div className="email-menu-list d-flex flex-column gap-1 mt-2">
                {inboxUser?.slice(0, 4).map((user, idx) => <Link to="" key={idx}>
