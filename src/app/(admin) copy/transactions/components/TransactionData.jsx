                ...
                <table className="table align-middle text-nowrap table-hover table-centered mb-0">
                  ...
                  <tbody>
                    {transactionData?.slice(0, 8).map((item, idx) => <tr key={idx}>
                        ...
                        <td>
                          <Link to="" onClick={toggle} className="link-primary fw-semibold" data-bs-toggle="modal" data-bs-target="#TransactionsViewModal">
                            TXN-{item.id}
                          </Link>
                        </td>
                        <td>
                          <div className="d-flex align-items-center gap-2">
                            <Link to="" className="rounded-circle">
                              <div className="position-relative">
                                {item.user?.avatar && <img src={item.user.avatar} alt="avatar" className="avatar-sm rounded-circle flex-shrink-0 " />}
                        ...
                        <td>
                          <div className="d-flex gap-2">
                            <div>
                              <img src={item.paymentMethod.card} alt="card" className="avatar-xs" />
                            </div>
                            <div>
          ...
          <Card className="border-0 mb-0 shadow-none">
            <CardBody className="p-0 pb-3">
              <div className="d-flex align-items-center gap-3">
                <Link to="" className="rounded-circle">
                  <div className="position-relative">
                    <img src={avatar1} alt="avatar" className="avatar-md rounded-circle flex-shrink-0 img-thumbnail" />
                    <span className="position-absolute bottom-0 end-0  rounded-circle">
                      <span>
                ...
                <div>
                  <Link to="" className="text-dark fw-semibold fs-18">
                    Ray C. Nichols
                  </Link>
              ...
              <div className="p-3 bg-primary bg-gradient rounded-4 mt-4 border border-light border-2 shadow-sm">
                <div className="d-flex align-items-center">
                  <img src={chip} alt="chip" className="avatar" />
                  <div className="ms-auto">
                    <img src={mastercard} alt="mastercard" className="avatar" />
                  </div>
                </div>
                <div className="mt-5">
                ...
                <div className="d-flex align-items-center justify-content-between mt-4">
                  ...
                  <img src={contactlessImg} alt="contactless-payment" className="img-fluid" />
                </div>
              </div>
              <div className="mt-4">
