      ...
      <CardBody>
        <div className="p-3 bg-primary bg-gradient rounded-4 border border-light border-2 shadow-sm">
          <div className="d-flex align-items-center">
            <img src={chipImg} alt="chip" className="avatar" />
            <div className="ms-auto">
              <img src={mastercardImg} alt="mastercard" className="avatar" />
            </div>
          </div>
          <div className="mt-5">
          ...
          <div className="d-flex align-items-center justify-content-between mt-4">
            ...
            <img src={contactlessImg} alt="contactless" className="img-fluid" />
          </div>
        </div>
        <div className="mt-4">
