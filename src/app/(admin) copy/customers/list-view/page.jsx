...
const CustomersListPage = () => {
  const customerData = useFetchData(getAllCustomer);
  return <>
        ...
        <Col xl={12}>
          <Card>
            <CardHeader className="d-flex justify-content-between align-items-center border-bottom">
              <div>
                <CardTitle as={'h4'}>Tenant ID</CardTitle>
              </div>
              <Dropdown>
                    ...
                    {customerData?.map((item, idx) => <tr key={idx}>
                        ...
                        <td>
                          <div className="d-flex align-items-center gap-2">
                            <div>{item.user?.avatar && <img src={item.user.avatar} alt="avatar" className="avatar-sm rounded-circle" />}</div>
                            <div>
