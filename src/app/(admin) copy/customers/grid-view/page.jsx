  ...
  return <Card className="overflow-hidden">
      <CardBody>
        <div className="customer-bg rounded position-relative">
          <img src={user?.avatar} alt="avatar2" className="avatar-xl border border-light border-3 rounded-circle position-absolute top-100 start-0 translate-middle ms-5" />
        ...
        <div className="mt-5 pt-3 ms-1">
          <div className="d-flex justify-content-between align-items-center mb-3">
            <Link to="/customers/details" className="fs-18 link-primary fw-semibold">
              {user?.name}
            </Link>
            <div>
...
const CustomerGridPage = () => {
  const customerGridData = useFetchData(getAllCustomer);
  return <>
