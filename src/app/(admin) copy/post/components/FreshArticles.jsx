...
const FreshArticles = () => {
  return <Col xl={5} lg={12}>
      <Card>
        <CardHeader>
          <CardTitle as={'h4'}>Fresh Articles, News &amp; Updates</CardTitle>
        </CardHeader>
        <CardBody>
          <img src={properties16} alt="properties" className="rounded-3 img-fluid" />
          <div className="mt-3">
            <span>
            ...
            <div className="d-flex align-items-center gap-1">
              <div className="position-relative">
                <img src={avatar2} alt="avatar2" className="avatar rounded-circle flex-shrink-0" />
              </div>
