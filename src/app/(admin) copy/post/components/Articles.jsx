        ...
        <CardBody>
          {articleData.map((item, idx) => <div className={`border-bottom pb-3 ${idx != 0 && 'py-3'} `} key={idx}>
              ...
              <div className="mb-2 mt-1">
                {item.tags.map((tag, idx) => <Fragment key={idx}>
          ...
          <div className="pt-3">
            ...
            <Row className="my-2 align-items-center">
              <Col lg={3}>
                <img alt="small" src={smallImg} className="rounded-3 img-fluid" />
              </Col>
              <Col lg={9}>
            ...
            <div className="d-flex align-items-center gap-1 mt-2 pt-1">
              <div className="position-relative">
                <img src={avatar1} alt="avatar" className="avatar rounded-circle flex-shrink-0" />
              </div>
              <div className="d-block ms-2 flex-grow-1">
                <span className="text-dark">
                  <Link to="" className="text-dark fw-medium">
