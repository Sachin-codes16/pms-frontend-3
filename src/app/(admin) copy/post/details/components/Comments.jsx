...
const Comments = () => {
  return <>
      {commentsData.map((item, idx) => <div className={`ps-0  ${idx == 1 ? 'pt-4' : 'pt-3'}  ${idx == 0 && 'border-top mt-3'}`} key={idx}>
          <div className="d-sm-flex align-items-top">
            <div className="position-relative">
              <img src={item?.image} alt="avatar" className="avatar rounded-circle flex-shrink-0" />
            </div>
            <div className="flex-grow-1 ms-sm-3">
              ...
              {item.reply && item.reply.map((reply, idx) => <div className="d-sm-flex align-items-top mt-4 " key={idx}>
                    <div className="position-relative">
                      <img src={reply.image} alt="avatar" className="avatar rounded-circle flex-shrink-0" />
                    </div>
                    <div className="flex-grow-1 ms-sm-3">
                      <span>
                        <Link to="" className="text-dark fw-medium">
            ...
            <Link to="" data-bs-toggle="tooltip" data-bs-title="Comment" data-bs-placement="top">
