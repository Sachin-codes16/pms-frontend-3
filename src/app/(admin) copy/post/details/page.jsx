          ...
          <Card>
            <CardBody>
              ...
              <div className="d-flex align-items-center gap-1 my-3">
                <div className="position-relative">
                  <img src={avatarImg} alt="avatar" className="avatar rounded-circle flex-shrink-0" />
                </div>
              ...
              <span className="text-dark d-inline-block mb-2 mt-1">
                <Link to="" className="text-dark fs-4 fw-medium">
              ...
              <div className="d-flex bg-light border border-dashed gap-3 rounded my-4 p-3">
                <Link to="" className="d-flex align-items-center fs-16 text-dark">
