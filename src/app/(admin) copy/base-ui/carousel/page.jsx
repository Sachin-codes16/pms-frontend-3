  ...
  return <ComponentContainerCard id="with-controls" title="With Controls" description={<>Adding in the previous and next controls:</>}>
      <div className="w-50 mb-3 mx-auto">
        <CarouselBootstrap indicators={false}>
          <CarouselItem>
            <img src={Img4} height={302} className="d-block h-auto w-100" alt="img-2" />
          </CarouselItem>
          <CarouselItem>
            <img src={Img2} height={302} className="d-block h-auto w-100" alt="img-3" />
          </CarouselItem>
          <CarouselItem>
            <img src={Img3} height={302} className="d-block h-auto w-100" alt="img-4" />
          </CarouselItem>
        </CarouselBootstrap>
      </div>
    </ComponentContainerCard>;
...
const SlidesWithIndicators = () => {
  return <ComponentContainerCard id="with-indicators" title="With Indicators" description={<> You can also add the indicators to the carousel, alongside the controls, too.</>}>
      ...
      <div className="w-50 mb-3 mx-auto">
        <CarouselBootstrap>
          <CarouselItem>
            <img src={Img5} height={302} className="d-block h-auto w-100" alt="img-5" />
          </CarouselItem>
          <CarouselItem>
            <img src={Img6} height={302} className="d-block h-auto w-100" alt="img-6" />
          </CarouselItem>
          <CarouselItem>
            <img src={Img7} height={302} className="d-block h-auto w-100" alt="img-7" />
          </CarouselItem>
        </CarouselBootstrap>
      </div>
      {/* </Col>
  ...
  return <ComponentContainerCard id="crossfade" title="Crossfade" description={<>
      ...
      <div className="w-50 mb-3 mx-auto">
        <CarouselBootstrap indicators={false} fade>
          <CarouselItem>
            <img src={Img1} height={302} className="d-block h-auto w-100" alt="img-2" />
          </CarouselItem>
          <CarouselItem>
            <img src={Img2} height={302} className="d-block h-auto w-100" alt="img-3" />
          </CarouselItem>
  ...
  return <ComponentContainerCard id="disable-touch-swiping" title="Disable touch swiping" description={<>
      ...
      <div className="w-50 mb-3 mx-auto">
        <CarouselBootstrap indicators={false} touch={false}>
          ...
          <CarouselItem>
            <img src={Img5} height={302} className="d-block h-auto w-100" alt="img-3" />
          </CarouselItem>
          <CarouselItem>
            <img src={Img6} height={302} className="d-block h-auto w-100" alt="img-4" />
          </CarouselItem>
        </CarouselBootstrap>
      </div>
      {/* </Row> */}
